...
var url = '${pageContext.request.contextPath}/admin/tree/getCheckedTreeMenu?userId='+userId;
...
function save(){
	...
	$.post('<%=request.getContextPath()%>/admin/user/role/update',{id:userId,menuIds:str},function(result){
		if(result.success){
