...
<body>
<div class="title">添加幼儿</div>
<form method="post" id="loginForm" name="loginForm" class="signupform" action='chileren/student/new_add'>
...
<div class="main">
    ...
    <div class="box1">
        ...
        <div class="box1_right">
            ...
            <input class="box1_input" type="text" name="id" disabled="disabled" placeholder="编号自动生成" value="${student.id }">
        </div>
    </div>
    <div class="box1">
        <div class="box1_left">
    ...
    <div class="box1">
        ...
        <div class="box1_right">
            ...
            <input class="box1_input" type="text" name="keeperPhone" value="${student.keeperPhone }">
        </div>
    </div>
    <div class="box1">
        <div class="box1">
            <h2 class="title_left_name">家庭住址：</h2>
                    <select id="provinces" name="provinces" value="${student.provinces }"></select> 
            		<select id="cities" name="cities" value="${student.cities }">></select>  
            		<select id="counties" name="counties" value="${student.counties }">></select>  
        </div>
    </div>
    <div class="box1">
        <div class="box1">
