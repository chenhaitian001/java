...
<form method="post" id="loginForm" name="loginForm" class="signupform" action='worker/teacher/new_add'>
...
<div class="main">
	...
	<div class="box1_right">
            ...
            <input type="text"  name="clazzid"  id="clazzId"  v-model="clazzId"  autocomplete="off" class="easyui-combobox box1_input_min" data-options="valueField:'cid',textField:'cname',url:'dictionary/clazz',editable:false"/>
        </div>
    </div>
    <div class="box1">
        <div class="box1_left">
    ...
    <div class="box1">
        <div class="box1">
            <h2 class="title_left_name">家庭住址：</h2>
            		...
            		<select id="counties" name="counties" ></select>  
        </div>
    </div>
    <div class="box1">
        <div class="box1">
...
<div style="text-align:center; ">
    <input type="button" onclick="submitForm()" class="registerBtn" value="添加"/>
</div>
</form>
...
$(function(){
	//下拉框 省市县赋值
	$('#provinces').find('option[value='+'${teacher.provinces}'+']').attr('selected','selected');
	$('#cities').find('option[value='+'${teacher.cities}'+']').attr('selected','selected');
	$('#counties').find('option[value='+'${teacher.counties}'+']').attr('selected','selected');
});
