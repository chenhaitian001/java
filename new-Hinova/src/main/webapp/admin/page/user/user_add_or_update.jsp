...
function save(){
	...
	$.post(save_url,{
		name:app.name
		,roleIds:$('#role').combobox('getValue')
	...
	<form class="layui-form layui-form-pane">
	  ...
	  <c:choose>
	   ...
	   <div class="layui-form-item">
	    ...
	    <input type="text"  name="role" value="${user.roleIds }" id="role"  v-model="role"  autocomplete="off" class="easyui-combobox" data-options="valueField:'id',textField:'name',url:'dictionary/role',editable:false"/>
          </div>
	  </div>
	   <%-- <div class="layui-form-item">
	    <label class="layui-form-label">所属园所</label>
	    <div class="layui-input-block layui-select" >
	    <input type="text"  name="school" value="${user.schoolIdS }" id="school"  v-model="school"  autocomplete="off" class="easyui-combobox" data-options="valueField:'id',textField:'name',url:'dictionary/school',editable:false"/>
          </div>
	  </div> --%>
	  <div class="layui-form-item">
