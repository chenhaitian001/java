...
<body class="easyui-layout">
				...
				<table id="_data_grid"
					...
					<thead>
						<tr>
							...
							<th data-options="field:'dksj',sortable:true" style="width:720px">打卡时间</th>
						</tr>
					</thead>
				</table>
			</div>
	...
	<script type="text/javascript">
		...
		function _search() {
			...
			_data_grid.datagrid("options").url='rpt2/pageDakajilu.do';
		...
		function _excel() {
			...
			window.open("rpt2/pageDakajilu_excel.do?" + param);
		}
	</script>
</body>
</html>