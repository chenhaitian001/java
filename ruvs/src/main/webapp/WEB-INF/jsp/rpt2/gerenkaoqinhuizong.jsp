...
<body class="easyui-layout">
				...
				<table id="_data_grid"
					...
					<thead>
						<tr>
							...
							<th data-options="field:'cqts',sortable:true" style="width:120px">出勤天数(天)</th>
	...
	<script type="text/javascript">
		...
		function _search() {
			...
			_data_grid.datagrid("options").url='rpt2/pageGerenkaoqinhuizong.do';
		...
		function _excel() {
			...
			window.open("rpt2/pageGerenkaoqinhuizong_excel.do?" + param);
		}
	</script>
</body>
</html>