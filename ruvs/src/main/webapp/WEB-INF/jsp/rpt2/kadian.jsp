			...
			<div data-options="region:'north',border:false"
				...
				<div id="search_area">
					...
					<input type="hidden" id="input_bumen_ids" name="bumen_ids">
						...
						<input type="text" class="easyui-datebox" name="sdate" value="${sdate }" style="width:100px">-<input type="text" class="easyui-datebox" name="edate" value="${edate }" style="width:100px"> 
