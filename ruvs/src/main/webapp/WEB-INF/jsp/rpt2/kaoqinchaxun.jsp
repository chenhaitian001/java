...
<body class="easyui-layout">
				...
				<table id="_data_grid"
					...
					<thead>
						<tr>
							...
							<th data-options="field:'date',sortable:true" style="width:120px">日期</th>
							<th data-options="field:'week',sortable:true" style="width:120px">星期</th>
							<th data-options="field:'dtlx',sortable:true" style="width:120px">当天类型</th>
							<th data-options="field:'glbc',sortable:true" style="width:120px">规律班次</th>
							<th data-options="field:'jbbc',sortable:true" style="width:120px">基本班次</th>
							<th data-options="field:'sdxx',sortable:true" style="width:120px">时段信息</th>
							...
							<th data-options="field:'kqbz',sortable:true" style="width:120px">考勤备注</th>
						</tr>
					</thead>
				</table>
			</div>
	...
	<script type="text/javascript">
		...
		function _search() {
			...
			_data_grid.datagrid("options").url='rpt2/pageKaoqinchaxun.do';
		...
		function _excel() {
			...
			window.open("rpt2/pageKaoqinchaxun_excel.do?" + param);
		}
	</script>
</body>
</html>