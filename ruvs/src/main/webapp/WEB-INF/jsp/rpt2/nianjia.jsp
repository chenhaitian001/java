...
<body class="easyui-layout">
				...
				<table id="_data_grid"
					...
					<thead>
						<tr>
							...
							<th data-options="field:'rzrq',sortable:true" style="width:90px">入职日期</th>
							<th data-options="field:'gzrq',sortable:true" style="width:90px">工作日期</th>
							<th data-options="field:'gl',sortable:true" style="width:90px">工龄</th>
							<th data-options="field:'snnj',sortable:true" style="width:90px">上年年假天数</th>
							<th data-options="field:'snyx',sortable:true" style="width:90px">已休上年天数</th>
							<th data-options="field:'jnnj',sortable:true" style="width:90px">今年年假天数</th>
							<th data-options="field:'jnyx',sortable:true" style="width:90px">已休今年年假</th>
							<th data-options="field:'jnsy',sortable:true" style="width:90px">今年剩余天数</th>
							<th data-options="field:'jssj',sortable:true" style="width:90px">统计时间</th>
							<th data-options="field:'note',sortable:true" style="width:90px">备注</th>
						</tr>
					</thead>
				</table>
			</div>
	...
	<script type="text/javascript">
		...
		function _search() {
			...
			_data_grid.datagrid("options").url='rpt2/pageNianjia.do';
		...
		function _excel() {
			...
			window.open("rpt2/pageNianjia_excel.do?" + param);
		}
	</script>
</body>
</html>