...
<body class="easyui-layout">
				...
				<table id="_data_grid"
					...
					<thead>
						<tr>
							...
							<th data-options="field:'ren_type',sortable:true" style="width:90px">人员类别</th>
							...
							<th data-options="field:'qj',sortable:true" style="width:120px">请假(天)</th>
						</tr>
					</thead>
				</table>
			</div>
	...
	<script type="text/javascript">
		...
		function _search() {
			...
			_data_grid.datagrid("options").url='v2/findDetail.do';
		...
		function _excel() {
			...
			window.open("v2/detail_excel.do?" + param);
		}
	</script>
</body>
</html>