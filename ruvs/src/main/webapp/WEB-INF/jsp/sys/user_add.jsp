		...
		<ul class="edit_area">
			...
			<li>
				...
				<span class="value"><input type="text" name="loginName" class="easyui-textbox" 
					data-options="required:true,validType:'length[2,50]'" maxlength="50" /></span>
			...
			<li>
				...
				<span class="value"><input type="password" id="_password" name="password" class="easyui-textbox"
					data-options="required:true,validType:'length[2,50]'" maxlength="50"/></span>
				<span class="rule"><span class="red">*</span>长度1-50个字符</span>
			</li>
			<li>
				<span class="text">确认密码</span>
				<span class="value"><input type="password" class="easyui-textbox"
					data-options="required:true,validType:'same[\'_password\']'" maxlength="50"/></span>
				<span class="rule"><span class="red">*</span>长度1-50个字符</span>
			</li>
			<li class="error"></li>
			<li>
