		...
		<ul class="edit_area">
			<li>
				...
				<span class="value">
					<input type="text" name="parent.id" class="easyui-combobox" 
						data-options="url:'combo/Resource/id/name.do',editable:false"/>
				</span>
			...
			<li>
				...
				<span class="value"><input type="text" name="url" class="easyui-textbox" 
					data-options="validType:'length[2,300]'"/></span>
			...
			<li>
				...
				<span class="value"><input type="text" name="sort" value="0" class="easyui-numberbox" 
