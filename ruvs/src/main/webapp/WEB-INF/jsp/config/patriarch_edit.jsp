...
<form id="_form" method="POST">
    ...
    <ul class="edit_area">
        <li>
            <span class="text">识别号</span>
            <span class="value"><input type="text" name="faceCode" class="easyui-textbox"
        ...
        <li>
            ...
            <span class="value"><input type="text" name="student.id"
                                       class="easyui-combobox" data-options="url:'combo/Student/id/name.do'"/></span>
            <span class="rule"><span class="red">*</span></span>
        </li>

        <li>
            <span class="text">关系</span>
            <span class="value"><input type="text" name="relation" class="easyui-textbox"
                                       data-options="required:true,validType:'length[2,50]'"/></span>
            <span class="rule"><span class="red">*</span>长度2-50个字符</span>
        </li>
        <li class="error" id="relationError"></li>
