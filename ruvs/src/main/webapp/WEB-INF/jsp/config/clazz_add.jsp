	...
	<form id="_form"   method="POST">
		<ul class="edit_area">
			...
			<li>
				...
				<span class="value"><input type="text" name="grade.id"
										   class="easyui-combobox" data-options="required:true,url:'combo/Grade/id/name.do',editable:false"/></span>
				<span class="rule"><span class="red">*</span></span>
			</li>
			<li class="error" id="grade.idError"></li>
