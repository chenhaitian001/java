...
$(this).click(function(event){
//edit by fuqiang jbox中的A标签的防止跳转
...
this._closeTimer=setTimeout(function(){alertMsg.close()},30000);}else{
$(this._bgId).show();}
...
return false;}
function navTabSearchNoResetPageNum(form,navTabId){
	var $form=$(form);
	  // if(form[DWZ.pageInfo.pageNum])form[DWZ.pageInfo.pageNum].value=1;
	navTab.reload($form.attr('action'),{data:$form.serializeArray(),navTabId:navTabId});
	return false;}
...
//window.location=url+(url.indexOf('?')==-1?"?":"&")+decodeURIComponent($form.serialize(),true);
...
/*edit by fuqiang; for input field maxlength begin "return "dwz."+this.lookupPk(key);}};" */
return ""+this.lookupPk(key);}};
/*edit by fuqiang; for input field maxlength end "return "dwz."+this.lookupPk(key);}};" */
$.extend({
...
/*edit by fuqiang; for input field maxlength begin */
fieldMaxLength:$th.attr("fieldMaxLength"),
/*edit by fuqiang; for input field maxlength end */
...
var $btnDel=$(this);
function delDbData(){
/*edit by fuqiang; for href javascript:void(0) td begin */
if(null==$btnDel.attr('href')||$btnDel.attr('href')=="javascript:void(0)"||$btnDel.attr('href')==""){
...
break;
case 'date':
html='<input type="text" name="'+field.name+'" class="date '+field.fieldClass+'" format="'+field.patternDate+'" size="'+field.size+' " yearstart="-120"  yearend="10" />'+'<a class="inputDateButton" href="javascript:void(0)">选择</a>';
break;
/*edit by fuqiang; for hidden input and hidden td begin */
case 'hidden':
	html='<input type="hidden" name="'+field.name+'" size="'+field.size+'" class="'+field.fieldClass+'"/>';
	break;
/*edit by fuqiang; for hidden input and hidden td end */
default:
if(null!=field.fieldMaxLength&&field.fieldMaxLength>0){
html='<input type="text" name="'+field.name+'" size="'+field.size+'" maxlength="'+field.fieldMaxLength+'" class="'+field.fieldClass+'"/>';
}else{
html='<input type="text" name="'+field.name+'" size="'+field.size+'" class="'+field.fieldClass+'"/>';	
}

break;}
if(field.type!='hidden'){return '<td>'+html+'</td>';}
/*edit by fuqiang; for hidden input and hidden td begin */
else{return '<td style="display:none;">'+html+'</td>';}
/*edit by fuqiang; for hidden input and hidden td end */
}
...
/*edit by fuqiang;将自动拼接的属性传给ACTION中的orderIndexs字段*/
/*return{name:selectedIds,value:val};})}else{*/
return{name:"orderIndexs",value:val};})}else{
var _data={};
/*_data[selectedIds]=ids;*/
_data["orderIndexs"]=ids;
return _data;}}(),
