...
function dTree(objName) {
	...
	this.icon = {
		root				: '<%=basePath%>sysadmin/images/dtree/base.gif',
		folder			: '<%=basePath%>sysadmin/images/dtree/folder.gif',
		folderOpen	: '<%=basePath%>sysadmin/images/dtree/folderopen.gif',
		node				: '<%=basePath%>sysadmin/images/dtree/page.gif',
		empty				: '<%=basePath%>sysadmin/images/dtree/empty.gif',
		line				: '<%=basePath%>sysadmin/images/dtree/line.gif',
		join				: '<%=basePath%>sysadmin/images/dtree/join.gif',
		joinBottom	: '<%=basePath%>sysadmin/images/dtree/joinbottom.gif',
		plus				: '<%=basePath%>sysadmin/images/dtree/plus.gif',
		plusBottom	: '<%=basePath%>sysadmin/images/dtree/plusbottom.gif',
		minus				: '<%=basePath%>sysadmin/images/dtree/minus.gif',
		minusBottom	: '<%=basePath%>sysadmin/images/dtree/minusbottom.gif',
		nlPlus			: '<%=basePath%>sysadmin/images/dtree/nolines_plus.gif',
		nlMinus			: '<%=basePath%>sysadmin/images/dtree/nolines_minus.gif'
	};
